...
function __wbg_adapter_20(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2f88be52bbfa5c38(arg0, arg1);
}
...
/**
*/
export const Key = Object.freeze({ Start:0,"0":"Start",Select:1,"1":"Select",B:2,"2":"B",A:3,"3":"A",Down:4,"4":"Down",Up:5,"5":"Up",Left:6,"6":"Left",Right:7,"7":"Right", });
/**
*/
export class JimbotWeb {

    static __wrap(ptr) {
        const obj = Object.create(JimbotWeb.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_jimbotweb_free(ptr);
    }
    /**
    * @param {Uint8Array} cartridge_bytes
    */
    constructor(cartridge_bytes) {
        const ptr0 = passArray8ToWasm0(cartridge_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.jimbotweb_new(ptr0, len0);
        return JimbotWeb.__wrap(ret);
    }
    /**
    ...
    */
    run(lcd_data) {
        try {
            var ptr0 = passArray8ToWasm0(lcd_data, wasm.__wbindgen_malloc);
            var len0 = WASM_VECTOR_LEN;
            wasm.jimbotweb_run(this.ptr, ptr0, len0);
        } finally {
            lcd_data.set(getUint8Memory0().subarray(ptr0 / 1, ptr0 / 1 + len0));
    ...
    */
    joypad_release(key) {
        wasm.jimbotweb_joypad_release(this.ptr, key);
    }
    /**
    * @param {number} key
    */
    joypad_press(key) {
        wasm.jimbotweb_joypad_press(this.ptr, key);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('jimbot_web_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
    ...
    imports.wbg.__wbg_setonpagehide_7f0c42610c50524d = function(arg0, arg1) {
        getObject(arg0).onpagehide = getObject(arg1);
    };

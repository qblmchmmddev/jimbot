...
impl PixelFifo {
    ...
    pub(crate) fn push_tile_pixel_row(&mut self, tile_pixel_row: [u8; 8]) {
    ...
    pub(crate) fn push_tile_pixel_row_front(&mut self, tile_pixel_row: [u8; 8]) {
    ...
    pub fn pop_front_8(&mut self) -> [u8; 8] {
        let mut res = [0; 8];
        for i in 0..8 {
